//********************************************************************
//  KJVFooter.js is used to close up the document page and adjust the
//  left nav menu.
//
...
CITATION = '<div class="cite2">'+dedicationCitation+'<p class="cite"><strong>Cite the BLB CD:</strong><br /><em>The Blue Letter Bible CD</em>. CD-ROM, version '+CDVERSION+'. Blue Letter Bible, ' +RELEASEDATE+'.</p></div>';
